...
contract IncentivePool is Param {
    ...
    function hasReceived(address account) public view returns(bool ret) {
        (,,ret) = tapvoting.readPartyDict(account);
        return ret;
    }
    function hasPrevReceived(uint256 _votingNumber, address account) public view returns(bool ret) {
